...
// experiments [Mr-HaleYa] indicate a bit larger value to be robust.
...
int DHT::_read()
{
  ...
  if (_type == 22) // this condition( DHT22, DHT33, DHT44) compatible
  {
